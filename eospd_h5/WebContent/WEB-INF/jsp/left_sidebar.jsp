...
<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="/eospd_h5/col_his"><i class="fa fa-dashboard fa-fw"></i> 历史数据</a></li>
			...
			<li><a href="/eospd_h5/cm_his"><i
					class="fa fa-table fa-fw"></i> 历史数据</a></li>
			<!--  
			<li><a href="#"><i
			...
			<li><a href="/eospd_h5/efd_chart"><i
				...
				<li><a href="/eospd_h5/efd_his"><i
					class="fa fa-edit fa-fw"></i> 电支路信息 </a></li>
