...
function ctopo(opt){
	...
	var defaultOpt = {
		id:"",    		//说明: canvas标签的id,     写法: canvas , #canvas
      	...
      	style:{                    //说明: 全局样式
	        ...
	        node:{
	          color:"#878787",     //说明: 节点颜色, 支持fillstyle所有原生写法, 优先级低于节点自带属性, 默认#00adee
	          size:20,             //说明: 节点直径, 优先级低于节点自带属性, 默认20px, 
	          textColor:"#000000", //说明: 节点Label颜色, 优先级低于节点自带属性, 默认#878787
	          textSize:20          //说明: 节点Label字体大小, 优先级低于节点自带属性, 默认10px
	        },
	        edge:{
	          color:"#c2c2c2",     //说明: 连线颜色, 支持fillstyle所有原生写法, 优先级低于节点自带属性, 默认#c2c2c2
              size:4,              //说明: 连线宽度, 优先级低于节点自带属性, 默认1px
              textColor:"#000000", //说明: 节点Label颜色, 优先级低于节点自带属性, 默认#878787
              textSize:20          //说明: 节点Label字体大小, 优先级低于节点自带属性, 默认10px
	        }
          },
	...
	function roundedRect(cornerX, cornerY, width, height, cornerRadius) {
    	console.log("cornerX:"+cornerX+", conrnerY:"+cornerY+", w:"+width);
